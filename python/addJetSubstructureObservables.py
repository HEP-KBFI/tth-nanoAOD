...
def addJetSubstructureObservables(process):
    ...
    process.jetSequence.replace(process.updatedJetsAK8WithUserData, process.QJetsAdderAK8 + process.jetAK8SubStructureVars + process.updatedJetsAK8WithUserData)
    # ----------------------------------------------------------------------------
