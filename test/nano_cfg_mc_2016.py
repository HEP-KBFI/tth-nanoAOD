...
# nanoAOD --step=NANO --era=Run2_2016,run2_miniAOD_80XLegacy --no_exec --fileout=tree.root --number=-1 \
...
# --conditions auto:run2_mc --python_filename=nano_cfg_mc_2016.py
...
if False:
  processDumpFile = open('nano_mc_2016.dump', 'w')
